                                                ...
                                                <form action="{{ route('customer.addToCart') }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            <img src="{{ asset('/img/' . $product->thumbnail) }}"
                                                                alt="{{ $product->thumbnail }}" width="290px;">
                                                        </div>
                                    ...
                                    <div class="col col-2">
                                        <div class="card border-0">
                                            <div class="card-header text-center">
                                                <img src="{{ asset('/img/' . $product->thumbnail) }}"
                                                    alt="{{ $product->thumbnail }}" width="100px;">
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="d-grid gap-2 mt-2">
                                                    <button class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModal{{ $product->id }}">Detail</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
